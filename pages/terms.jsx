  ...
  return (
    <Layout>
      ...
      <div className="min-h-screen px-10 lg:px-20">
        <div className="my-10">
          <h2 className="text-2xl font-bold mb-2">利用規約</h2>
          <p>
        ...
        <div className="mb-10">
          ...
          <ul className="list-decimal list-inside ml-7">
        ...
        <div className="mb-10">
          <h2 className="font-bold mb-2">第4条（利用料金および支払方法）</h2>
          <p>
        ...
        <div className="mb-10">
          ...
          <ul className="list-disc list-inside ml-7">
            ...
            <ul className="list-none list-inside ml-7">
        ...
        <div className="mb-10">
          <h2 className="font-bold mb-2">第6条（保証の否認および免責等）</h2>
          <ul className="list-decimal list-inside ml-7">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <h2 className="font-bold mb-2">第7条（本サービスの提供の停止等）</h2>
          <ul className="list-decimal list-inside ml-7">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <h2 className="font-bold mb-2">第8条（知的財産権等）</h2>
          <p>
        ...
        <div className="mb-10">
          <h2 className="font-bold mb-2">第9条（利用制限および登録抹消）</h2>
          <p>
            当社は、以下の場合には、事前の通知なく、データを削除し、ユーザーに対して本サービスの全部もしくは一部の利用を制限しまたはユーザーとしての登録を抹消することができるものとします。
          </p>
          <ul className="list-decimal list-inside ml-7 my-2">
        ...
        <div className="mb-10">
          <h2 className="font-bold mb-2">第10条（サービス内容の変更等）</h2>
          <p>
            当社は、ユーザーに通知することなく、本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし、これによってユーザーに生じた損害について一切の責任を負いません。
          </p>
        </div>
        <div className="mb-10">
          <h2 className="font-bold mb-2">第11条（秘密保持）</h2>
          <p>
        ...
        <div className="mb-10">
          <h2 className="font-bold mb-2">第12条（個人情報・本情報の取扱い）</h2>
          <ul className="list-decimal list-inside ml-7">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <h2 className="font-bold mb-2">第13条（反社会的勢力）</h2>
          <ul className="list-decimal list-inside ml-7">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <h2 className="font-bold mb-2">第14条（利用規約の変更）</h2>
          <ul className="list-decimal list-inside ml-7">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <h2 className="font-bold mb-2">第15条（本利用規約およびその他の利用規約等の有効性）</h2>
          <ul className="list-decimal list-inside ml-7">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <h2 className="font-bold mb-2">第16条（権利義務の譲渡の禁止）</h2>
          <ul className="list-decimal list-inside ml-7">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <h2 className="font-bold mb-2">第17条（準拠法・裁判管轄）</h2>
          <p>

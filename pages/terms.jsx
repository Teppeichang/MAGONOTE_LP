  ...
  return (
    <Layout>
      ...
      <div className="min-h-screen px-10 lg:px-20">
        <div className="my-10">
          <p className="text-2xl font-bold mb-2 tracking-wide lg:tracking-wider">利用規約</p>
        ...
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第1条（適用）</p>
          <p className="tracking-wide lg:tracking-wider">
        ...
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第2条（利用登録）</p>
          <p className="tracking-wide lg:tracking-wider">
            登録希望者が当社の定める方法によって利用登録を申請し、当社がこれを承認することによって、利用登録が完了するものとします。
            当社は、利用登録の申請者に以下の事由があると判断した場合、利用登録の申請を承認しないことがあり、その理由については一切の開示義務を負わないものとします。
          </p>
          <ul className="list-decimal list-inside ml-7 tracking-wide lg:tracking-wider">
        ...
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第3条（ユーザーIDおよびパスワードの管理）</p>
          <p>
        ...
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第4条（利用料金および支払方法）</p>
          <p>
        ...
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第5条（禁止事項）</p>
          <p>ユーザーは、本サービスの利用にあたり、以下の行為をしてはならないものとします。</p>
          <ul className="list-disc list-inside ml-7 tracking-wide lg:tracking-wider">
            <li className="-indent-6">
              ユーザーは、本サイトおよび本サービスを利用するにあたり、以下の各行為またはその恐れのある行為をしてはならないものとします。
            </li>
            <ul className="list-none list-inside ml-7 tracking-wide lg:tracking-wider">
        ...
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第6条（保証の否認および免責等）</p>
          <ul className="list-decimal list-inside ml-7 tracking-wide lg:tracking-wider">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第7条（本サービスの提供の停止等）</p>
          <ul className="list-decimal list-inside ml-7 tracking-wide lg:tracking-wider">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第8条（知的財産権等）</p>
          <p className="tracking-wide lg:tracking-wider">
        ...
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第9条（利用制限および登録抹消）</p>
          <p className="tracking-wide lg:tracking-wider">
            当社は、以下の場合には、事前の通知なく、データを削除し、ユーザーに対して本サービスの全部もしくは一部の利用を制限しまたはユーザーとしての登録を抹消することができるものとします。
          </p>
          <ul className="list-decimal list-inside ml-7 my-2 tracking-wide lg:tracking-wider">
        ...
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第10条（サービス内容の変更等）</p>
          <p className="tracking-wide lg:tracking-wider">
            当社は、ユーザーに通知することなく、本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし、これによってユーザーに生じた損害について一切の責任を負いません。
          </p>
        </div>
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第11条（秘密保持）</p>
          <p className="tracking-wide lg:tracking-wider">
        ...
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第12条（個人情報・本情報の取扱い）</p>
          <ul className="list-decimal list-inside ml-7 tracking-wide lg:tracking-wider">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第13条（反社会的勢力）</p>
          <ul className="list-decimal list-inside ml-7 tracking-wide lg:tracking-wider">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第14条（利用規約の変更）</p>
          <ul className="list-decimal list-inside ml-7 tracking-wide lg:tracking-wider">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第15条（本利用規約およびその他の利用規約等の有効性）</p>
          <ul className="list-decimal list-inside ml-7 tracking-wide lg:tracking-wider">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第16条（権利義務の譲渡の禁止）</p>
          <ul className="list-decimal list-inside ml-7 tracking-wide lg:tracking-wider">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <p className="font-bold mb-2 tracking-wide lg:tracking-wider">第17条（準拠法・裁判管轄）</p>
          <p className="tracking-wide lg:tracking-wider">
        ...
        <div className="mb-10">
          <p className="tracking-wide lg:tracking-wider">附則 令和5年4月1日 作成・施行</p>
          <p className="tracking-wide lg:tracking-wider">本規約の問い合わせ先：株式会社Next Stage（info@next-stage.biz）</p>
        </div>
      </div>
    </Layout>
  );

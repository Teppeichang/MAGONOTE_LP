...
const FacebookReport = () => {
  ...
  return (
    <Layout>
      ...
      <div className="flex flex-col justify-center mx-10 lg:flex lg:flex-row lg:justify-center">
        <div className="flex flex-col max-w-xl m-6">
          <p className="font-bold text-2xl py-5">Facebook広告レポートの概要</p>
          <p className="pb-5">
      ...
      <div className="flex justify-center mx-16">
        <div className="flex flex-col max-w-xl mr-14">
          <p className="font-bold text-2xl py-5">Facebook広告レポートの基本情報</p>
          <ul className="list-disc list-inside pb-5">
          ...
          <p className="font-bold text-2xl py-5">Facebook広告レポートの導入の流れ</p>
          <ul className="list-disc list-inside pb-5">
            <li>お申し込み（お客様）</li>
      ...
      <div className="flex justify-center mx-10">
        <div className="flex flex-col max-w-xl m-6">
          <p className="font-bold text-2xl py-5">Facebook広告レポートに含まれるレポート一覧</p>
          <ul className="list-disc list-inside pb-5">
            <li>日別レポート</li>
            <li>週別レポート</li>
            <li>月別レポート</li>

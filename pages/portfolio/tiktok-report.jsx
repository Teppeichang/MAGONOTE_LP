      ...
      <Reveal animation={Animation.FadeInUp}>
        <div className="flex flex-col justify-center mx-6 mt-20 lg:flex lg:flex-row lg:justify-center lg:mx-10">
          <div className="flex flex-col max-w-xl lg:mr-7">
            ...
            <Link href={"/trial"}>
              <button className="font-mPlus2c bg-purple-800 text-white w-64 h-12 mt-6 font-bold rounded-full tracking-wide hover:bg-white hover:text-purple-800 hover:border-solid hover:border hover:border-purple-800 transform active:scale-90 transition-transform lg:tracking-wider">
                デモレポートを見る
              </button>
            </Link>
          </div>

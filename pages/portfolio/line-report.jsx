    ...
    <Layout>
      ...
      <div className="flex justify-center mx-10">
        <div className="flex flex-col max-w-xl m-6">
          <p className="font-bold text-2xl py-5">LINE広告レポートの概要</p>
          <p className="pb-5">
      ...
      <div className="flex justify-center mx-16">
        <div className="flex flex-col max-w-xl mr-14">
          <p className="font-bold text-2xl py-5">LINE広告レポートの基本情報</p>
          <ul className="list-disc list-inside pb-5">
            <li>データソース：LINE広告</li>
          ...
          <p className="font-bold text-2xl py-5">LINE広告レポートの導入の流れ</p>
          <ul className="list-disc list-inside pb-5">
            <li>お申し込み（お客様）</li>
      ...
      <div className="flex justify-center mx-10">
        <div className="flex flex-col max-w-xl m-6">
          <p className="font-bold text-2xl py-5">LINE広告レポートに含まれるレポート一覧</p>
          <ul className="list-disc list-inside pb-5">
            <li>日別レポート</li>
            <li>週別レポート</li>
            <li>月別レポート</li>
          ...
          <p className="font-bold text-2xl py-5">LINE広告レポートに含まれるディメンションと指標</p>
          <p>

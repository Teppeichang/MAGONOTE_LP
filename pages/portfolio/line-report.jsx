  ...
  return (
    <Layout>
      ...
      <div className="min-h-screen mt-10 lg:flex lg:justify-center">
        <div className="px-20">
          <h2 className="font-bold text-xl py-5">LINE広告レポートの概要</h2>
          <p className="pb-5">
          ...
          <h2 className="font-bold text-xl py-5">LINE広告レポートの導入の流れ</h2>
          <ul className="list-disc list-inside pb-5">
            <li>お申し込み（お客様）</li>
          ...
          <h2 className="font-bold text-xl py-5">LINE広告レポートに含まれるレポート一覧</h2>
          <ul className="list-disc list-inside pb-5">
            <li>日別レポート</li>
            <li>週別レポート</li>
            <li>月別レポート</li>
          ...
          <h2 className="font-bold text-xl py-5">LINE広告レポートに含まれるディメンションと指標</h2>
          <p>
            LINE広告の管理画面で使えるほぼすべての項目が利用可能です。詳しくは無料トライアルの実際のレポートでご確認ください。また、項目の不足があれば追加も可能ですのでお問合せください。
          </p>
        </div>
        <div className="px-20 pb-20">
          <Image src="/images/4da13f27211a8ffbdd9d1ff88f877952.png" width={640} height={720} quality={90} objectFit="contain"></Image>
          <Image src="/images/4da13f27211a8ffbdd9d1ff88f877952.png" width={640} height={720} quality={90} objectFit="contain"></Image>
          <Image src="/images/4da13f27211a8ffbdd9d1ff88f877952.png" width={640} height={720} quality={90} objectFit="contain"></Image>
        </div>
      </div>

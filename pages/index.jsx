  ...
  return (
    <Layout>
      <div className="flex flex-col justify-center items-start bg-slate-50 py-40 mx-6 lg:flex lg:flex-col lg:justify-center lg:items-center lg:min-h-screen lg:py-0 lg:mx-0">
        <p className="font-bold text-3xl mb-4 tracking-wide lg:tracking-wider lg:text-5xl lg:text-center lg:mb-10">
          完全無料で
        ...
        <p className="text-base tracking-wide lg:tracking-wider lg:text-center lg:text-xl">
          アクセス解析・広告・SNSまで幅広いレポートに対応完全無料ですぐはじめられます。
        </p>
        <p className="tracking-wide lg:tracking-wider lg:text-center lg:text-xl">
          レポート対応メディアは順次追加予定
        </p>
        <button className="bg-purple-800 text-white hover:bg-white hover:text-purple-800 hover:border-solid hover:border hover:border-purple-800 font-bold py-2 px-4 rounded-full mt-6 tracking-wide lg:tracking-wider lg:text-2xl lg:w-96 lg:h-16">
      ...
      <div className="flex flex-col justify-center items-center bg-slate-50 pt-24 mx-6 lg:flex-row lg:pt-20">
        ...
        <div className="flex flex-col max-w-lg mt-8 mx-6 lg:mt-0 lg:ml-10">
          <p className="font-bold text-center text-3xl tracking-wide lg:tracking-wider lg:text-left lg:text-4xl">
            カスタマイズ可能な豊富なテンプレート
          </p>
          <div className="hidden lg:flex lg:items-center lg:mt-0.5">
            <Image
              ...
              quality={90}
            />
            <p className="text-base ml-3 tracking-wide lg:tracking-wider">About</p>
          </div>
          <p className="text-base mt-4 tracking-wide lg:tracking-wider lg:mt-10">
      ...
      <div className="flex flex-col justify-center items-center bg-slate-50 mt-28 py-10 mx-6 lg:mt-20 lg:py-20">
        <p className="font-bold text-center pb-10 text-3xl tracking-wide lg:tracking-wider lg:text-4xl">
          利用できるレポートのテンプレート
        </p>
        <div className="lg:py-10">
          <div className="flex flex-col lg:flex lg:flex-row">
            <div className="max-w-lg">
              <p className="text-xl font-bold mb-4 tracking-wide lg:tracking-wider lg:px-10">
                Facebook広告レポート
              </p>
              ...
              <p className="pb-10 tracking-wide lg:tracking-wider lg:px-10">
            ...
            <div className="max-w-lg">
              <p className="text-xl font-bold mb-5 tracking-wide lg:tracking-wider lg:px-10">
                LINE広告レポート
              </p>
              <div className="lg:px-5">
                <Image
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="max-w-lg">
              <h2 className="text-xl font-bold mb-5 tracking-wide lg:tracking-wider lg:px-10">
        ...
        <button className="bg-purple-800 text-white hover:bg-white hover:text-purple-800 hover:border-solid hover:border hover:border-purple-800 font-bold py-2 px-4 rounded-full w-44 mb-32 tracking-wide lg:tracking-wider lg:mb-10">
      ...
      <div className="flex flex-col items-center bg-gradient-to-r from-purple-800 to-purple-600 mx-3 lg:mx-0 lg:w-screen">
        <p className="font-bold text-center text-2xl text-white mt-14 mx-4 tracking-wide lg:tracking-wider lg:mt-20 lg:mx-0">
          今すぐ無料でレポートを自動化し、改善アクションに時間を使おう
        </p>
        <button className="bg-white text-purple-800 font-bold py-2 px-4 rounded-full mt-8 mb-14 w-52 tracking-wide lg:tracking-wider lg:mb-20">
          <Link href={"/trial"}>今すぐ無料で始める</Link>
        </button>
      </div>
      <div className="flex flex-col justify-center items-center bg-slate-50 mt-20 mx-6 lg:px-20">
        <p className="font-bold text-center text-3xl tracking-wide lg:tracking-wider lg:text-4xl">
          マーケティング担当者自らがノーコードで使える機能
        </p>
        <p className="text-center mt-4 tracking-wide lg:tracking-wider">
          実務を理解したマーケティング担当者自らがノーコードで使える機能を活用して<br />スマートにビジネスを成長させましょう。
        </p>
      </div>
      <div className="flex flex-col-reverse bg-slate-50 mt-4 lg:flex lg:flex-row lg:justify-center">
        <div className="max-w-lg mx-6 lg:px-20 lg:py-20 lg:mx-0">
          <p className="text-center text-2xl font-bold mt-4 tracking-wide lg:tracking-wider lg:text-left">
            すべてのデータを一元化
          </p>
          <p className="mt-2 text-base tracking-wide lg:tracking-wider">
      ...
      <div className="flex flex-col-reverse bg-slate-50 mt-4 lg:flex lg:justify-center lg:flex-row-reverse">
        <div className="max-w-lg mx-6 lg:px-20 lg:py-20 lg:mx-0">
          <p className="text-center text-2xl font-bold mt-4 tracking-wide lg:tracking-wider lg:text-left">手間なくレポート作成</p>
          <p className="mt-2 text-base tracking-wide lg:tracking-wider">
      ...
      <div className="flex flex-col-reverse bg-slate-50 mt-4 lg:flex lg:flex-row lg:justify-center">
        <div className="max-w-lg mx-6 lg:px-20 lg:py-20 lg:mx-0">
          <p className="text-center text-2xl font-bold mt-4 tracking-wide lg:tracking-wider lg:text-left">簡単にレポートを共有</p>
          <p className="mt-2 text-base tracking-wide lg:tracking-wider">

  ...
  return (
    <Layout>
      <div className="flex flex-col justify-center items-start bg-slate-50 py-40 mx-6 lg:flex lg:flex-col lg:justify-center lg:items-center lg:min-h-screen lg:py-0 lg:mx-0">
        ...
        <button className="font-mPlus2c bg-purple-800 text-white hover:bg-white hover:text-purple-800 hover:border-solid hover:border hover:border-purple-800 font-bold py-2 px-4 rounded-full mt-6 tracking-wide lg:tracking-wider lg:text-2xl lg:w-96 lg:h-16">
      ...
      <div className="flex flex-col-reverse bg-slate-50 mt-4 lg:flex lg:justify-center lg:flex-row-reverse">
        <div className="max-w-lg mx-6 lg:px-20 lg:py-20 lg:mx-0">
          <p className="font-mPlus2c text-center text-2xl font-bold mt-4 tracking-wide lg:tracking-wider lg:text-left">手間なくレポート作成</p>
          <p className="font-mPlus2c mt-2 text-base tracking-wide lg:tracking-wider">
      ...
      <div className="flex flex-col-reverse bg-slate-50 mt-4 lg:flex lg:flex-row lg:justify-center">
        <div className="max-w-lg mx-6 lg:px-20 lg:py-20 lg:mx-0">
          <p className="font-mPlus2c text-center text-2xl font-bold mt-4 tracking-wide lg:tracking-wider lg:text-left">簡単にレポートを共有</p>
          <p className="font-mPlus2c mt-2 text-base tracking-wide lg:tracking-wider">

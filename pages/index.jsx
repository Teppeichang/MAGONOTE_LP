  ...
  return (
    <Layout>
      ...
      <div className="flex flex-col justify-center items-center px-10 pb-20 lg:px-20 lg:pt-40">
        <h2 className="font-bold text-center pt-40 text-2xl lg:text-4xl">カスタマイズ可能な豊富なテンプレート</h2>
      ...
      <div className="flex flex-col justify-center items-center py-10 lg:py-20">
        <h2 className="font-bold text-center px-10 pb-10 text-2xl lg:text-4xl">利用できるレポートのテンプレート</h2>
        <div className="p-10 lg:py-10">
          <div className="flex flex-col lg:flex-row">
            <div>
              ...
              <p className="pb-10 lg:px-10">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            </div>
            <div>

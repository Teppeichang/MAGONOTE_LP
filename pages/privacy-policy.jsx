...
const PrivacyPolicy = () => {
  const lists = [
    { string: "トップページ", path: "/" },
    { string: "プライバシーポリシー", path: "/privacy-policy" },
  ];
  return (
    <Layout>
      ...
      <div className="min-h-screen px-10 lg:px-20">
        <div className="my-10">
          <p className="text-2xl font-bold mb-2 tracking-wide lg:tracking-wider">プライバシーポリシー</p>
        ...
        <div className="mb-10">
          <p className="text-2xl font-bold mb-2 tracking-wide lg:tracking-wider">第1条（個人情報）</p>
          <p className="tracking-wide lg:tracking-wider">
        ...
        <div className="mb-10">
          <p className="text-2xl font-bold mb-2 tracking-wide lg:tracking-wider">第2条（個人情報の収集方法）</p>
          <p className="tracking-wide lg:tracking-wider">
            当社は、ユーザーが利用登録をする際に氏名、生年月日、住所、電話番号、メールアドレス、銀行口座番号、クレジットカード番号、運転免許証番号などの個人情報をお尋ねすることがあります。また、ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を,当社の提携先（情報提供元、広告主、広告配信先などを含みます。以下、｢提携先｣といいます。）などから収集することがあります。
          </p>
        </div>
        <div className="mb-10">
          <p className="text-2xl font-bold mb-2 tracking-wide lg:tracking-wider">第3条（個人情報を収集・利用する目的）</p>
          <p className="mb-2 tracking-wide lg:tracking-wider">当社が個人情報を収集・利用する目的は、以下のとおりです。</p>
          <ul className="list-disc list-inside ml-7 tracking-wide lg:tracking-wider">
            ...
            <li className="-indent-6">メンテナンス、重要なお知らせなど必要に応じたご連絡のため</li>
            <li className="-indent-6">
            ...
            <li className="-indent-6">有料サービスにおいて、ユーザーに利用料金を請求するため</li>
            <li className="-indent-6">上記の利用目的に付随する目的</li>
          </ul>
        </div>
        <div className="mb-10">
          <p className="text-2xl font-bold mb-2 tracking-wide lg:tracking-wider">第4条（利用目的の変更）</p>
          <ul className="list-disc list-inside ml-7 tracking-wide lg:tracking-wider">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <p className="text-2xl font-bold mb-2 tracking-wide lg:tracking-wider">第5条（個人情報の第三者提供）</p>
          <ul className="list-disc list-inside ml-7 tracking-wide lg:tracking-wider">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <p className="text-2xl font-bold mb-2 tracking-wide lg:tracking-wider">第6条（個人情報の開示）</p>
          <ul className="list-disc list-inside ml-7 tracking-wide lg:tracking-wider">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <p className="text-2xl font-bold mb-2 tracking-wide lg:tracking-wider">第7条（個人情報の訂正および削除）</p>
          <ul className="list-disc list-inside ml-7 tracking-wide lg:tracking-wider">
            <li className="-indent-6">
              ユーザーは、当社の保有する自己の個人情報が誤った情報である場合には当社が定める手続きにより、当社に対して個人情報の訂正、追加または削除（以下、「訂正等」といいます。）を請求することができます。
            </li>
            <li className="-indent-6">
              当社は、ユーザーから前項の請求を受けてその請求に応じる必要があると判断した場合には遅滞なく、当該個人情報の訂正等を行うものとします。
            </li>
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <p className="text-2xl font-bold mb-2 tracking-wide lg:tracking-wider">第8条（個人情報の利用停止等）</p>
          <ul className="list-disc list-inside ml-7 tracking-wide lg:tracking-wider">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <p className="text-2xl font-bold mb-2 tracking-wide lg:tracking-wider">第9条（プライバシーポリシーの変更）</p>
          <ul className="list-disc list-inside ml-7 tracking-wide lg:tracking-wider">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <p className="text-2xl font-bold mb-2 tracking-wide lg:tracking-wider">第10条（お問い合わせ窓口）</p>
          <p className="tracking-wide lg:tracking-wider">本ポリシーに関するお問い合わせは、下記の窓口までお願いいたします。</p>
          <p className="tracking-wide lg:tracking-wider">住所：〒114-0003 東京都北区豊島1-15-3 セントラル王子901</p>
          <p className="tracking-wide lg:tracking-wider">社名：株式会社Next Stage</p>
          <p className="tracking-wide lg:tracking-wider">メールアドレス：info@next-stage.biz</p>
        </div>
      </div>
    </Layout>
  );

  ...
  return (
    <Layout>
      ...
      <div className="min-h-screen px-10 lg:px-20">
        ...
        <div className="mb-10">
          <h2 className="text-2xl font-bold mb-2">第1条（個人情報）</h2>
          <p>
        ...
        <div className="mb-10">
          <h2 className="text-2xl font-bold mb-2">第2条（個人情報の収集方法）</h2>
          <p>
            当社は、ユーザーが利用登録をする際に氏名、生年月日、住所、電話番号、メールアドレス、銀行口座番号、クレジットカード番号、運転免許証番号などの個人情報をお尋ねすることがあります。また、ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を,当社の提携先（情報提供元、広告主、広告配信先などを含みます。以下、｢提携先｣といいます。）などから収集することがあります。
          </p>
        </div>
        <div className="mb-10">
          <h2 className="text-2xl font-bold mb-2">第3条（個人情報を収集・利用する目的）</h2>
        ...
        <div className="mb-10">
          <h2 className="text-2xl font-bold mb-2">第4条（利用目的の変更）</h2>
          <ul className="list-disc list-inside ml-7">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <h2 className="text-2xl font-bold mb-2">第5条（個人情報の第三者提供）</h2>
          <ul className="list-disc list-inside ml-7">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <h2 className="text-2xl font-bold mb-2">第6条（個人情報の開示）</h2>
          <ul className="list-disc list-inside ml-7">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <h2 className="text-2xl font-bold mb-2">第7条（個人情報の訂正および削除）</h2>
          <ul className="list-disc list-inside ml-7">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <h2 className="text-2xl font-bold mb-2">第8条（個人情報の利用停止等）</h2>
          <ul className="list-disc list-inside ml-7">
            <li className="-indent-6">
        ...
        <div className="mb-10">
          <h2 className="text-2xl font-bold mb-2">第9条（プライバシーポリシーの変更）</h2>
          <ul className="list-disc list-inside ml-7">
            <li className="-indent-6">

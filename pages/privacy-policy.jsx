...
const PrivacyPolicy = () => {
  const lists = [{string: "トップページ", path: "/"}, {string: "プライバシーポリシー", path: "/privacy-policy"}]
  return (
    <Layout>
      ...
      <div className="mb-10 mx-10">
        ...
        <ul className="list-disc list-inside">
          ...
          <ul className="list-disc list-inside">
            ...
            <li>予め次の事項を告知あるいは公表し，かつ当社が個人情報保護委員会に届出をしたとき利用目的に第三者への提供を含むこと</li>
      ...
      <div className="mb-10 mx-10">
        ...
        <p>住所：〒170-0003 東京都豊島区駒込2-6-3 大和駒込ビル2F<br></br>社名：株式会社Next Stage<br></br>Eメールアドレス：test@example.co.jp</p>
      </div>
    </Layout>
  )
}
